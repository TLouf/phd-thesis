...
\epigraph{
  ...
  \epigraphcite{Gell-MannQuarkJaguar1995}
}
...
presentation of the empirical aspect of our methods, before introducing the kind of physics-inspired
...
comparison, our ability to collect it is quite limited.
...
biases \cite{PickfordAmericanLinguistic1956,AlshenqeetiInterviewingData2014,DeBenitoMorenoCreatingDesigning2016}. 
...
\label{sec:method_theoretical_models}
...
not so different from models defined at the macroscopic level. What they definitely
bring to the table is how they enable us to study how some properties of the social
structure may matter in sustaining the observed dynamics. We here refer again to the
...
everyone would be perfectly connected. Then to understand the ``complexity'' that emerges from
this, a model that describes dynamics that can happen on any kind of complex network of
interaction is invaluable. This idea of using simple models to try to understand the seemingly complex emergence of some global features from social dynamics is the central methodological foundation of this thesis, that it inherits from physics.
To give examples, \acp{ABM} can provide insights into questions
