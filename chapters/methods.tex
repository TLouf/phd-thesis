...
One of the first things to consider when trying to model a phenomenon is at what level we wish to study it. % TODO meh
We will here distinguish between two levels: the micro and the macro. 
% start iwth macr only approach, then hey but we can start from micro and get macro behaviour ,that's like statistical physics
...
% micro \cite{AxelrodDisseminationCulture1997}, \cite{SchellingDynamicModels1971}
% macro \cite{HanskiMetapopulationDynamics1998}
% Modeling language shift has been the subject of much research in the last decades \cite{Castellano2009,Boissonneault2021}, which employed various approaches such as the formulation of evolution equations based on ecological models \cite{Mira2005, Pinasco2006, Kandler2008, Sole2010,Heinsalu2014}, of reaction-diffusion equations \cite{Kandler2009,Patriarca2009,Isern2014,Prochazka2017}, or approaches within the framework of agent-based modeling \cite{Castello2006, Minett2008,Castello2013,Prochazka2017}.
