...
\begin{figure}
\centering
    \includegraphics[width=0.8\linewidth]{models_diagram}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{single_pop_stream_plots}
...
\begin{figure}[hp!]
\centering
    \includegraphics{single_to_metapop_BE}
...
\begin{figure}
\centering
    \includegraphics{varying_c_sep_to_mix_to_sep}
