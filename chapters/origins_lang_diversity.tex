...
% All in all, whether politics push against or towards language diversity is a matter of
% the political will of the moment, which depends on many factors that are hardly predictable. Language is a very important political weapon.
...
% There thus seems that linguistic and socio-economic segregations are in part mutually-sustaining 
...
% for a mix of political, economic and cultural reasons, can bind people together, and at the same time separate them from others, as it distinguishes them from other groups. immigrants \cite{LamannaImmigrantCommunity2018} first obvious, but also SES \cite{LevyAbitbolSocioeconomicDependencies2018}. Linguistic ghettos
